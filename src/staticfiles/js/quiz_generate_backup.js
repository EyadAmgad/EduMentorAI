document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializePage() {
        ...
        // Ensure Generated Questions button is visible
        if (viewQuizButton) {
            viewQuizButton.style.display = 'none'; // Initially hidden until quiz is generated
        }
    }    // Call initialization
    initializePage();
        ...
        form.addEventListener('submit', async function(e) {
            ...
            if (data.success) {
                ...
                if (data.google_form_url) {
                    ...
                    // Hide action buttons if no Google Form
                    if (viewQuizLinkButton) {
                        viewQuizLinkButton.style.display = 'none';
                    }
                    if (editQuizLinkButton) {
